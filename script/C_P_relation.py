...
def choose_pic_folder():
    global pic_path
    pic_dir = "Cmp-Files" + out_exp_path.split('/')[-1] + "-" + out_linear_path.split('/')[-1]
...
def draw_3D(file_name):
      ...
      for angle in angle_list:
          ...
          ax.scatter3D(dictL["cvs"][0],dictL["cvs"][1],dictL["cvs"][2], s=[30] ,c = "r",marker = 'o')
          ax.scatter3D(dictE["cvs"][0],dictE["cvs"][1],dictE["cvs"][2], s=[10] ,c = "black",marker = 'o')
